...
import 'package:online_order_app/data/models/transaction_model.dart';

class StoreApi {
  final List<ProductModel> _productsDb = [
    ProductModel(
      id: 'CDRC-1',
      name: 'Corduroy cap',
      description:
  ...
  final List<CartItemModel> _cartDb = [];

  final List<TransactionModel> _transactionDb = [];
  ...
  Future<ProductModel?> fetchProductById(String id) async {
    ...
    final product = _productsDb.firstWhereOrNull((element) => element.id == id);
